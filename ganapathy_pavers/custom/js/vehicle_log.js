...
frappe.ui.form.on("Vehicle Log" ,{
    onload:function(frm){
        ...
        //     return {
        //         filters:{
        //             'designation': ["in", ['Driver', 'Supervisor']]
        //         }
        //     }
        // });
    },
...
function distance(frm){
    frm.set_value('today_odometer_value', (frm.doc.odometer?frm.doc.odometer:0) - (["Fuel", "Service"].includes(frm.doc.select_purpose)?(frm.doc.fuel_odometer_value || 0):(frm.doc.last_odometer || 0)))
}
