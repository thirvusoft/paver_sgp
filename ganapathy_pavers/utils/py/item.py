...
def batch_property_setter():                
    ...
    make_property_setter("Item", "brand", "depends_on", "eval:doc.item_group != 'Compound Walls' && doc.item_group != 'Pavers'", "Data")
    make_property_setter("Item", "opening_stock", "depends_on", "eval:doc.item_group != 'Compound Walls' && doc.item_group != 'Pavers'", "Data")
    make_property_setter("Item", "valuation_rate", "depends_on", "eval:doc.item_group != 'Compound Walls' && doc.item_group != 'Pavers'", "Data")
    make_property_setter("Item", "standard_rate", "depends_on", "eval:doc.item_group != 'Compound Walls' && doc.item_group != 'Pavers'", "Data")
    make_property_setter("Item", "is_fixed_asset", "depends_on", "eval:doc.item_group != 'Compound Walls' && doc.item_group != 'Pavers'", "Data")
