...
def get_stock_qty(item_code, warehouse, date, time=None, to_uom = None, uom_conv = True):
	qty = 0
	for i in warehouse:
	...
	if to_uom:
		return uom_conversion(item=item_code, from_uom=None, from_qty=qty, to_uom=to_uom)
