    ...
    if doc.get("stock_entry_type")=="Manufacture" and type == "create_stock_entry":
        ...
        if doc.get("damage_qty") > 0:
            if default_scrap_warehouse:
                stock_entry.append('items', dict(
                    t_warehouse = default_scrap_warehouse, item_code = doc.get("item_to_manufacture")	,qty = doc.get("damage_qty"), uom = default_nos, is_scrap_item = 1
                    ))
            else:
        ...
        if doc.get("rack_shift_damage_qty") > 0:
            stock_entry.append('items', dict(
                t_warehouse = default_scrap_warehouse, item_code = doc.get("item_to_manufacture"),qty = doc.get("rack_shift_damage_qty"),uom = default_nos,  is_scrap_item = 1
                ))
        stock_entry.append('additional_costs', dict(
        ...
        if doc.get("curing_damaged_qty") > 0:
            stock_entry.append('items', dict(
                t_warehouse = default_scrap_warehouse, item_code = doc.get("item_to_manufacture")	,qty = doc.get("curing_damaged_qty"), uom = default_nos, is_scrap_item = 1
                ))
        stock_entry.append('additional_costs', dict(
