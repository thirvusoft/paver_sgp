...
def execute(filters=None):
	...
	cw_items = []
	if cw_list:
		cw_items = frappe.db.get_list("CW Items",filters={'parent':['in',cw_list]},fields=["item",'sum(produced_qty) as produced_qty','sum(ts_production_sqft) as production_sqft'],group_by="item",order_by="item")
