"apps/erpnext/erpnext/accounts/report/general_ledger/general_ledger.py"
...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql(
		"""
		select
			name as gl_entry, posting_date, account, 
			case 
				when type = 'Compound Walls'
					then "Compound Wall"
				when ifnull(type, '') = ''
...
def get_conditions(filters):
	...
	if filters.get("type"):
		if filters.get("type")=="Compound Wall":
			conditions.append("type in ('Compound Wall','Compound Walls')")
		else:
